...
-- Script date 3/12/2019 17:01:29
...
CREATE TABLE t_audiencia (
  ...
  t_AudiObservaciones text NOT NULL,
  t_casocod int(11) NOT NULL,
...
CREATE TABLE stripe (
  ...
  item_price_currency varchar(255) DEFAULT NULL,
...
(1, 'Audiencia', 'Se registro una audiencia', '<i class="fas fa-exclamation"></i>', 1),
(2, 'Observación', 'Se registro una observación', '<i class="far fa-bell"></i>', 0),
(3, 'Cancelación', 'Cancelación de caso.', '<i class="fas fa-ban"></i>', 1),
(4, 'Nuevo caso', 'Se registró nuevo caso.', '<i class="fas fa-exchange-alt"></i>', 0),
(5, 'Adelanto', 'Se paga un adelanto', '<i class="fas fa-exchange-alt"></i>', 1);

-- 
-- Dumping data for table t_usuario
--
INSERT INTO t_usuario VALUES
(4, 1, 'CORRUPTUS', '123456', NULL, NULL, NULL),
(5, 2, 'raul@mail.com', '123456', NULL, NULL, NULL),
(6, 2, 'frank@email.com', '123456', NULL, NULL, NULL),
(7, 2, 'gac184@hotmail.com', '654321', NULL, NULL, NULL),
(8, 2, 'grover@mail.com', '1234', NULL, NULL, NULL),
(9, 2, 'stripe_dev@protonmail.com', '$2y$10$TgOzcg1P0SFxGAoO.4GoQu/a13LxVG.Kn8Pmq6biu3Ur2qDdaVJ1O', '', 0, NULL),
(11, 2, 'george.rendich@gmail.com', '$2y$10$V3HFLuA4xUQuSjvNbrwPueySOB0LIUqOk2Agtmfbz.4qSdyQcHE/u', NULL, NULL, NULL),
(12, 2, 'gaby.arias@gmail.com', '$2y$10$AhUUuZ4DqyOHwpO/dOCeduI9mlaj5iUSA2a.mmAcuRmeXYSPu93fa', NULL, NULL, NULL),
(17, 2, 'george.rendich@gmail.com', '', NULL, NULL, '2656665601059636');
...
(12, 2, '', '', '', '10453767243', 'ABC', 'Jr. Guido 985 - Hyo (San Carlos)', '123456', '954663322', '0000-00-00', '1', '1', '1', NULL),
(13, 1, 'Tania', 'Salcedo Buendia', '78451263', '', '', 'Jr. Libertad 556', '987556622', '', '1999-12-03', '1', '1', '1', NULL);
...
(19, '2019-12-03', 1, 'Adelanto de pago', 'Monto: 122 por concepto de: adelanto', 5),
(20, '2019-12-03', 1, 'Nuevo caso', 'Nuevo caso', 4),
(21, '2019-12-03', 1, 'Adelanto de pago', 'Monto: 200 por concepto de: Adelanto', 5),
(22, '2019-12-03', 1, 'Conciliacion', 'Nueva audiencia', 1);
...
(13, 'Estafa', 13, 4, '2019-12-03', '00001201903135JRCO08', 2, 'JUEZ DE PAZ PAMPAS', '', 0.00, 11, 13, 6, 3, 1);
...
--
-- Table systemcase.t_verificacion does not contain any data (it is empty)

-- 
-- Dumping data for table t_resolucion
--
-- Table systemcase.t_resolucion does not contain any data (it is empty)
...
(7, '122', 0, 'adelanto', 7, '2019-12-03 11:52:44'),
(8, '200', 0, 'Adelanto', 13, '2019-12-03 15:06:40');
...
(8, 'Conciliacion', 'Jr parra 521', '04:30:00', '2019-12-11', '', 13, 1, 2);

-- 
-- Dumping data for table t_apelacion
--
-- Table systemcase.t_apelacion does not contain any data (it is empty)

-- 
-- Dumping data for table t_abogado
--
INSERT INTO t_abogado VALUES
(2, 'HUGO ANDRES', 'CASTILLO ROMERO', 986532651, 'AV. LARCO 660', 987653251, 0, 'acastillo@syscase.com', 'Junin', 'Lima', 'Cercado', '', 11);

-- 
-- Dumping data for table stripe
--
INSERT INTO stripe VALUES
(1, 'Grover', 'grover@mail.com', '4000056655665556 ', '03', '2021', 'subscription', 'PN12345', '2500', 'USD', '2500', 'usd', 'txn_1FlLebJSUECxf0XAfZEVv4Zl', 'succeeded', '2019-12-02 15:37:58', '2019-12-02 15:37:58', 0),
(2, 'Frank Canchari', '45068903@continental.edu.pe', '5200828282828210', '03', '2022', 'subscription', 'PN12345', '2500', 'USD', '2500', 'usd', 'txn_1FlM4UJSUECxf0XAspKhhU00', 'succeeded', '2019-12-02 16:04:43', '2019-12-02 16:04:43', 0),
(3, 'Raul', 'julian@mail.com', '4000056655665556', '03', '2021', 'subscription', 'PN12345', '2500', 'USD', '2500', 'usd', 'txn_1FlMBJJSUECxf0XAfT4tCI1n', 'succeeded', '2019-12-02 16:11:47', '2019-12-02 16:11:47', 0),
(4, 'Frank Canchari', '45068903@continental.edu.pe', '4000056655665556', '03', '2021', 'subscription', 'PN12345', '2500', 'USD', '2500', 'usd', 'txn_1FlMm8JSUECxf0XAHPa3xiRZ', 'succeeded', '2019-12-02 16:49:49', '2019-12-02 16:49:49', 0);
