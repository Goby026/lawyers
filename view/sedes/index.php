        ...
        <div class="col-md-12 d-flex flex-wrap justify-content-around">
            <?php foreach($sedes as $row): ?>
                <div class="card text-center mb-5" style="width: 18rem">
                    <a href="?c=categoriaasiento&a=index&d=<?php echo $row->idSede ?>"><img src="data:image/jpeg; base64, <?php echo  base64_encode($row->imgSede); ?>" class="card-img-top estadio" style="height: 200px"></a>
                    <div class="card-body">
